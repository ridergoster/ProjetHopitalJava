...
public class SSHTunnel {
    ...
    public boolean connect() {
        ...
        try {
            ...
            System.out.println("Connexion SSH echouee : mauvais identifiant ou utilisateur introuvable");
        }
